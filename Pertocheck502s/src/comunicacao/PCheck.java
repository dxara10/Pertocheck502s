...
public class PCheck {
    ...
    private PchekCommModerno pchekComm;
    ...
    public void executaComando(String paramStr, int paramInt) throws Erro {
        try {
            ...
            if (pchekComm.processaComando(paramStr, paramInt)) {
                String resposta = PchekCommModerno.getResposta();
    ...
    public void init() throws Erro {
        ...
        try {
            ...
            pchekComm = new PchekCommModerno(porta, baudRate);
    ...
    public static String getResposta() {
        return PchekCommModerno.getResposta();
    }
